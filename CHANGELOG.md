## 3.3.16 2022-12-11 <dave at tiredofit dot ca>
...
## 3.3.12 2022-11-28 <dave at tiredofit dot ca>
   ...
   ### Changed
      - Fix for new installs failing


## 3.3.11 2022-11-22 <dave at tiredofit dot ca>

   ### Added
      - Add OVERWRITE_CLI_URL (credit radarsymphony@github)


## 3.3.10 2022-11-19 <dave at tiredofit dot ca>

   ### Added
      - Notify Push Plugin 0.5.0


## 3.3.9 2022-11-03 <dave at tiredofit dot ca>

   ### Added
      - Nextcloud 23.0.11


## 3.3.8 2022-10-17 <dave at tiredofit dot ca>
...
## 3.3.5 2022-10-05 <dave at tiredofit dot ca>

   ### Changed
      - Migrate legacy nginx configuration


## 3.3.4 2022-09-11 <dave at tiredofit dot ca>

   ### Added
      - Nextcloud 23.0.9


## 3.3.3 2022-08-17 <dave at tiredofit dot ca>

   ### Added
      - Start using exec statements


## 3.3.2 2022-08-12 <dave at tiredofit dot ca>
...
## 3.3.0 2022-08-05 <dave at tiredofit dot ca>
   ...
   ### Reverted
      - Remove fail2ban from image and rely on base image
...
## 3.2.10 2022-06-23 <dave at tiredofit dot ca>
   ...
   ### Changed
      - Fix for bad release supporting tiredofit/nginx:6.0.0 and nginx-php-fpm:7.0.0


## 3.2.9 2022-06-23 <dave at tiredofit dot ca>
